...
|参数名称 | 必选 | 类型 | 描述|
|--------|-----|-----|-----|
|origin| 是 | string      |起点经纬度：lng,lat，经度和维度之间","分隔，经纬度小数点后不超过6位。   |
|road_levels     | 否 | string      |起点绑路道路等级：1高速道路，2城市高速，3国道，4省道，5县道，6乡镇村道，7其它道路，8九级路，9轮渡，10行人道路，11人渡，12自行车专用道。如果输入多个等级，1&#124;2&#124;3&#124;…，则只返回指定等级的道路；没有输入，则返回所有等级道路     |
|road_func_classes  | 否 | string     |起点绑路道路功能等级，1&#124;2&#124;…    |
|road_name | 否 | string|起点绑路道路名称   |
...
|avoid_polygons | 否 | string|区域避让，当前仅支持矩形区域，最多30个。区域之间"$"分隔，每个区域的经纬度之间"&#124;"分隔，经度和维度之间","分隔 |
|avoid_road | 否 | string|避让道路名，只支持一条。|
|avoid_types | 否 | string|避让：1（轮渡）、2（收费）、3（高速）。多种避让类型代码之间“&#124;”分隔|
